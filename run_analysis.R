...
# QUESTION 1: MERGE TRAINING AND TEST DATA --------------------------------------------
...
# QUESTION 2-4: EXTRACT ONLY  MEAN AND STD ----------------------------------
#the columns are already named approprietly while loading, see lines: 30,54
#activities are also added with names, see lines:40,64
merged_features_selected <- merge_features %>%
  select(matches ('activity|mean|std|idsubject'))


# QUESTION 5: CREATE AVERAGE OF EACH VARIABLE FOR EACH ACTIVITY/SU --------
